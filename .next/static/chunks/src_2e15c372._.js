...
function handleDateConversion(projectData) {
    const project = {
        ...projectData,
...
function coerceDates(projectData) {
    const project = {
        ...projectData
    };
...
function ProjectProvider({ children }) {
    ...
    const loadProjects = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProjectProvider.useCallback[loadProjects]": async ()=>{
            setIsLoading(true);
            try {
                const fetchedProjects = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchProjects"])();
    ...
    }["ProjectProvider.useCallback[loadProjects]"], [
        toast
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const addProject = async (project)=>{
        try {
            const newProject = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addProject"])(project);
            setProjects((prev)=>[
                    newProject,
                    ...prev
                ]);
    ...
    const updateProject = async (project)=>{
        try {
            const updatedProject = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateProject"])(project);
    ...
    const deleteProject = async (id)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteProject"])(id);
    ...
    const handleFormSubmit = async (data, selectedProject)=>{
...
_s(ProjectProvider, "rOmd1bRdFl9LFS9YC3sVkTvMr8o=", false, function() {
    return [
...
//# sourceMappingURL=src_2e15c372._.js.map